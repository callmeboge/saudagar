...
switch($_GET[act]){
  ...
  <input type=text name='jdl_video' size=60>
   ...
   <textarea  name='editor' id='editor' class='ckeditor' style='width: 720px; height: 250px;'></textarea>
   </p> 	
	
		
   <p class=inline-small-label> 
   <label for=field4>Recommended</label>
   <select name='rekom'>
   <option value='---'>---</option>
  ...
  <input type=text name='jdl_video' size=60 value='$r[jdl_video]'>
   ...
   <p class=inline-small-label> 
   <label for=field4>Keterangan</label>
   <textarea  name='editor' id='editor' class='ckeditor' style='width:720px; height: 250px;'>$r[keterangan]</textarea>
   </p> 	 
	 
   <p class=inline-small-label> 
   <label for=field4>Recommended</label>
   <select name='rekom'>
   <option value='$r[rekomendasi]'>$r[rekomendasi]</option>
   <option value='Y'>Y</option>
   <option value='N'>N</option>
   </select>
   </p>  
