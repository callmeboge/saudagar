      ...
      <!-- <a href="lombamewarnaiislami" style="margin-bottom:10px;display:block;">
        ...
        <div class="col-xs-12 col-lg-8">
            ...
            <div id="carousel-example-generic" class="carousel slide carousel-fade hl-slider" data-ride="carousel" style="height:auto;">
              ...
              <?php
              $terkini=mysql_query("SELECT * FROM berita, menu WHERE headline='Y' AND berita.id_kategori = menu.id_menu AND menu_dari = 'sulsel' ORDER BY id_berita DESC LIMIT 3");
              ...
              <div class='col-xs-12' style='float:none;padding-left:0;'>
                ...
                <ol class='carousel-indicators' style='position:relative;'>
                  <?php
                    $terkini=mysql_query("SELECT * FROM berita, menu WHERE headline='Y' AND menu.id_menu = berita.id_kategori AND menu_dari='sulsel' ORDER BY id_berita DESC LIMIT 3 ");
                    $i = 0;
          ...
          <div class="col-xs-12" style="margin-top:7px;padding:0;">
              <div class="single_blog_sidebar1 berita-terkini wow fadeInUp">
                ...
                <?php
                  $x=1;
                  $detail1=mysql_query("SELECT * FROM berita, menu WHERE id_kategori = id_menu AND menu_dari = 'sulsel' AND jenis_berita <> 'foto' ORDER BY id_berita DESC LIMIT 16");
                  while($p1=mysql_fetch_array($detail1))
                  {
                    if($x%5 == 0):
                      ...
                      $inilah = mysql_query("SELECT * FROM berita, menu WHERE id_kategori = id_menu AND menu_dari='sulsel' AND jenis_berita = 'foto' $add_q ORDER BY id_berita DESC LIMIT 1");
                    ...
                    elseif($x == 14):
                      echo "<li><ul class='featured_nav0 berita-lainnya' style='border-bottom:1px solid #ececec;'>
                            ...
                            $detail2=mysql_query("SELECT * FROM berita, menu WHERE id_kategori = id_menu AND menu_dari='sulsel' AND jenis_berita <> 'foto' AND utama='Y' order by id_berita DESC limit 6");
        ...
        <div class="col-xs-12 col-lg-4 hidden-sm hidden-md" style="padding-left:30px">
          ...
          (adsbygoogle = window.adsbygoogle || []).push({});
            ...
            <div class="single_blog_sidebar berita-foto wow fadeInUp">
              ...
              <?php
              $foto = mysql_query("SELECT * FROM berita, menu WHERE id_menu = id_kategori ORDER BY id_berita DESC LIMIT 1");
